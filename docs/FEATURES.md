...
| 10 | Measured reinforcement campaigns | Isolated attempts produce verifier results; policy installation requires the campaign's independent audit path. | [Campaign tool](../cockpit/src/tools/rl_campaign.rs), [campaign tests](../cockpit/src/rl_ctl/campaign_tests.rs) |
