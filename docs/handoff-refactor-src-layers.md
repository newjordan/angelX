> **Superseded 2026-09-21.** The `src/` layer reorganization below landed on `main`;
> this file is kept for its module-to-bucket map and placement rule. The live
> handoff is the repo-root `HANDOFF.md`.
