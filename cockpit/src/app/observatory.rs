...
use crate::ui::hud::{HUD_BLUE, HUD_DANGER, HUD_DIM, HUD_GOLD, HUD_PHOSPHOR, HUD_TEXT};
...
const SUCCESS: Color = Color::Rgb(
    crate::ui::term::art::DMD_PALETTE[7][0],
    crate::ui::term::art::DMD_PALETTE[7][1],
    crate::ui::term::art::DMD_PALETTE[7][2],
);
...
fn default_manifest_path() -> PathBuf {
    ...
    if std::env::var_os("ANGEL_OBSERVATORY_DEV_FIXTURE").is_some() {
        let repository_fixture = crate::platform::runtime_paths::cockpit_dir()
