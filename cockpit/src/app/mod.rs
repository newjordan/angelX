...
pub(crate) enum WorldButton {
    ...
    FormationDeck,
    SelectFormation(crate::agent::formations::FormationId),
    ...
    RlView(crate::ui::viz::rl_viz::RlView),
    Research(crate::drive::research_workspace::Action),
    ...
    #[allow(dead_code)]
    ScryglassPin,
    Still(crate::ui::still_inspector::Action),
    ScryglassMap,
    ScryglassEnter,
    ScryglassLeave,
    ScryglassCatalog,
    ...
    ScryglassFollow,
    #[allow(dead_code)]
    ScryglassLandmark(crate::stage::world_viz::Building),
...
pub(crate) struct LastCompletedRoute {
    pub(crate) route: crate::agent::club::RouteIdentity,
    pub(crate) completed_ms: u64,
    pub(crate) verdict: Option<crate::knowledge::experience::RouteVerdict>,
}
...
pub(crate) struct PendingAtlasHarvest {
    pub(crate) atlas: Arc<crate::knowledge::atlas::AtlasService>,
...
pub(crate) struct App {
    ...
    pub(crate) startup_intro: crate::app::startup_intro::StartupIntro,
    ...
    pub(crate) atlas_view: crate::knowledge::atlas::AtlasViewState,
    /// Shared request broker for the interactive agent's read-only UI view.
    pub(crate) ui_broker: Arc<crate::ui::ui_inspect::UiSnapshotBroker>,
    ...
    pub(crate) agentviz_portal: crate::ui::viz::agentviz_portal::PortalRuntime,
    ...
    pub(crate) bg_job: Option<control::BackgroundJob>,
    ...
    pub(crate) background_notice_tx: mpsc::Sender<control::BackgroundNotice>,
    pub(crate) background_notice_rx: mpsc::Receiver<control::BackgroundNotice>,
    ...
    pub(crate) stream_text_sanitizer: control::TerminalTextSanitizer,
    pub(crate) partial_height_cache: transcript::PartialHeightCache,
    pub(crate) stream_artifact_detector: crate::app::control::StreamArtifactDetector,
    ...
    pub(crate) reasoning_text_sanitizer: control::TerminalTextSanitizer,
    ...
    pub(crate) divider_motion: crate::ui::pane_motion::Divider,
    ...
    /// (see `crate::ui::views::agent_view::PORTRAIT_MARKER_LIFETIME`); nothing has to clear it.
    pub(crate) portrait_turn_marker:
        Option<(crate::ui::views::agent_view::PortraitMarker, Instant)>,
    ...
    pub(crate) cache_meter: crate::agent::turn::CacheMeter,
    /// The session goal for a long-running task (`/goal`); shown in `/status`.
    pub(crate) goal: Option<crate::drive::goal::Goal>,
    ...
    pub(crate) campaign: crate::drive::campaign::CampaignController,
    /// Operator-authorized campaign work occupying the same one-flight
    /// boundary as an interactive turn.
    pub(crate) campaign_pending: Option<crate::app::control::CampaignPending>,
    /// The autonomous `/loop` controller state (persisted; see `loop_ctl.rs`).
    pub(crate) loop_ctl: crate::drive::loop_ctl::LoopState,
    ...
    pub(crate) loop_dialog: Option<crate::drive::loop_dialog::LoopLaunchDialog>,
    /// Clickable regions from the last loop dialog draw.
    pub(crate) loop_dialog_hits: Vec<crate::drive::loop_dialog::LoopDialogHit>,
    ...
    pub(crate) moa_deck: Option<crate::agent::formations::MoaDeckState>,
    /// One amplified SOTA-MoA formation + exact model roster for the next turn.
    pub(crate) moa_one_shot: Option<crate::agent::formations::MoaEngagement>,
    /// Session-long formation roster; every user turn is prefixed with `moa:`.
    pub(crate) moa_session: Option<crate::agent::formations::MoaEngagement>,
    ...
    pub(crate) keybinds: Vec<control::Keybind>,
    ...
    pub(crate) clipboard_paste: crate::ui::clipboard::ClipboardPaste,
    ...
    pub(crate) observatory: crate::app::observatory::ObservatoryState,
    ...
    pub(crate) scryglass: crate::ui::scryglass::Scryglass,
    ...
    pub(crate) agent_menu_hits: crate::ui::agent_panel::controls::AgentMenuHits,
    ...
    pub(crate) route_evidence: crate::knowledge::route_intelligence::RouteEvidenceSnapshot,
    ...
    pub(crate) last_turn_outcome: Option<crate::agent::backplane::TurnOutcome>,
    ...
    pub(crate) visual_motion: crate::ui::viz::lifecycle_viz::MotionMode,
    ...
    pub(crate) scryglass_drag: Option<crate::stage::world_viz::world_camera::WorldDrag>,
...
pub(crate) struct LifecycleCeremony {
    pub(crate) kind: crate::ui::viz::lifecycle_viz::CeremonyKind,
    pub(crate) label: String,
    pub(crate) started: Instant,
}
...
impl App {
    ...
    pub(crate) fn start_lifecycle_ceremony(
        &mut self,
        kind: crate::ui::viz::lifecycle_viz::CeremonyKind,
        ...
        if !stage_available
            || !self
                .scryglass
                .controller
                .show_overlay(crate::ui::scryglass::StageOverlay::Lifecycle { kind })
        {
            return false;
        }
        crate::ui::viz::lifecycle_viz::warm_assets();
        ...
        self.world.set_completion_ceremony_active(matches!(
            ...
            crate::ui::viz::lifecycle_viz::CeremonyKind::GoalDone
                | crate::ui::viz::lifecycle_viz::CeremonyKind::GoalCleared
        ));
        let _ = self
            .module_host
    ...
    pub(crate) fn lifecycle_ceremony_animating(&self) -> bool {
        crate::drive::comp_mode::ambient_stage_sim_allowed()
            ...
            && matches!(
                ...
                Some(crate::ui::scryglass::StageOverlay::Lifecycle { .. })
            )
    ...
    pub(crate) fn moa_deck_animating(&self) -> bool {
        match self.visual_motion {
            ...
            | crate::ui::viz::lifecycle_viz::MotionMode::Reduced => self
                .moa_deck
                .as_ref()
                .is_some_and(|deck| deck.transition().is_some()),
            crate::ui::viz::lifecycle_viz::MotionMode::Off => false,
        }
    }
    ...
    pub(crate) fn from_parts(
        ...
        let agentviz_portal = crate::ui::viz::agentviz_portal::PortalRuntime::discover(
            viewer.supports_agentviz_portal(),
        );
        let (background_notice_tx, background_notice_rx) = mpsc::channel();
        let campaign = if session.is_disabled() {
            crate::drive::campaign::CampaignController::disabled(tools.current_workspace())
        } else {
            crate::drive::campaign::CampaignController::open(tools.current_workspace())
        };
        let mut app = Self {
            messages: Vec::new(),
            input: String::new(),
            startup_intro: crate::app::startup_intro::StartupIntro::default(),
            tutor_draft: None,
            ...
            atlas_view: crate::knowledge::atlas::AtlasViewState::default(),
            tools,
            ui_broker: crate::ui::ui_inspect::interactive_broker(),
            viewer,
            agentviz_portal,
            shell: None,
            shell_focused: false,
            ...
            partial: String::new(),
            stream_text_sanitizer: control::TerminalTextSanitizer::default(),
            ...
            reasoning_text_sanitizer: control::TerminalTextSanitizer::default(),
            reasoning_shown: 0,
            reasoning_scroll: 0,
            ...
            portrait_fail_run: 0,
            cache_meter: crate::agent::turn::CacheMeter::default(),
            goal: None,
            campaign,
            ...
            clipboard_paste: crate::ui::clipboard::ClipboardPaste::new(),
            composer_selection_anchor: None,
            skill_completion_catalog: None,
            workspace_completion_cache: None,
            media: Vec::new(),
            media_scroll: 0,
            observatory: crate::app::observatory::ObservatoryState::default(),
            quest_stage: None,
            ...
            visual_motion: crate::ui::viz::lifecycle_viz::MotionMode::from_env(),
            ...
            route_evidence: crate::knowledge::route_intelligence::RouteEvidenceSnapshot::default(),
            ...
            .filter_map(|m| match m.role {
                ...
                ChatRole::Assistant
                    if !m.content.is_empty()
                        && !crate::agent::compaction::is_plan_snapshot(&m.content) =>
                {
    ...
    pub(crate) fn spend_coin_motion(&self) -> crate::ui::viz::lifecycle_viz::MotionMode {
    ...
    pub(crate) fn spend_coin_active(&self) -> bool {
        self.spend_coin.as_ref().is_some_and(|coin| {
            crate::ui::viz::spend_viz::is_active(
    ...
    pub(crate) fn stage_display_wants_fast_tick(&self) -> bool {
        ...
        self.quick_lookup_roll_pending()
            ...
            || self.scryglass.surface == crate::ui::scryglass::StageSurface::Raytrace
            || self.moa_deck_animating()
            || self.loop_ctl.cycle_started_ms.is_some()
            || self.spend_coin_animating()
            || crate::ui::viz::loop_viz::hammertime_active(&self.loop_ctl)
    }
    ...
    fn agent_menu_profile_choice(&self) -> Option<crate::agent::club::RouteChoice> {
        ...
        match menu.kind {
            crate::ui::agent_panel::controls::AgentMenuKind::Model => {
                choices.get(menu.selected).cloned()
            }
    ...
    pub(crate) fn agent_menu_effort_preview(&self) -> Option<String> {
        ...
        let choices = self.bag.route_choices();
        match menu.kind {
            crate::ui::agent_panel::controls::AgentMenuKind::Model => choices
                .get(menu.selected)
    ...
    pub(crate) fn image_viewer_title(&mut self) -> Cow<'_, str> {
        let Some(label) = self.viewer.label() else {
            ...
            return Cow::Borrowed(crate::ui::views::status_view::image_viewer_title());
        };
