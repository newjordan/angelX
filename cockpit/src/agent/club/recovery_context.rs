...
pub(crate) fn owned_recovery_context_ref() -> RecoveryContextRef {
    RecoveryContextRef {
        ...
        workspace_sha256: crate::knowledge::cut::sha256_hex(b"owned-workspace"),
        experiment_key_sha256: crate::knowledge::cut::sha256_hex(b"owned-hypothesis"),
        summary_sha256: crate::knowledge::cut::sha256_hex(b"diagnostic"),
        producer: None,
    }
}
