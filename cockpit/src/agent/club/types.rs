...
pub(crate) struct ToolReceipt {
    ...
    pub(crate) outcome: crate::agent::harness::ToolOutcome,
    pub(crate) routing: Option<crate::agent::harness::shell_verifier::RoutingReceipt>,
}
...
impl ChatMsg {
    ...
    pub(crate) fn with_verified_workspace(
        ...
        let verified = self
            .tool_receipt
            .as_ref()
            .is_some_and(|r| crate::knowledge::caddy::verified_recipe_call(&r.call, &self));
        if single
            && verified
    ...
    pub(crate) fn with_routing_receipt(
        mut self,
        routing: Option<crate::agent::harness::shell_verifier::RoutingReceipt>,
    ) -> Self {
...
#[cfg(test)]
#[path = "../../../../tests/cockpit/club/types__meter_cell_tests.rs"]
...
#[cfg(test)]
#[path = "../../../../tests/cockpit/club/types__media_tests.rs"]
mod media_tests;
