...
impl AccountingCell {
    pub(crate) fn attempt(&self) -> AccountingAttempt<'_> {
        AccountingAttempt {
            ...
            observation: None,
            trace_attempt: crate::agent::harness::begin_provider_attempt(self.id),
            request_bytes: None,
            response_bytes: None,
        }
    }
...
pub(crate) struct AccountingAttempt<'a> {
    ...
    formation_reservation: Option<crate::agent::harness::formation_budget::Reservation>,
...
impl Drop for AccountingAttempt<'_> {
    fn drop(&mut self) {
        ...
        crate::agent::harness::note_provider_bytes(
            self.trace_attempt,
            self.request_bytes,
            self.response_bytes
                .as_ref()
        ...
        crate::agent::harness::end_provider_attempt(self.trace_attempt, self.observation);
    }
}
