...
fn audit_store_rollout_receipt_at_depth(
    ...
    let mut receipt = json!({
        ...
        "project": {
            ...
            "workspace_key_sha256": crate::knowledge::cut::sha256_hex(manifest.project.workspace_key.as_bytes()),
            "repo_key_sha256": crate::knowledge::cut::sha256_hex(manifest.project.repo_key.as_bytes()),
    ...
    let receipt_sha256 = crate::knowledge::cut::sha256_hex(
...
fn export_audited_rollout_v2(
    ...
    if termination.final_answer_sha256.as_deref()
        != Some(crate::knowledge::cut::sha256_hex(answer.as_bytes()).as_str())
    {
