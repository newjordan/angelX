use crate::agent::club::RouteIdentity;
...
pub(crate) struct RecordedMessage {
    ...
    pub(crate) recovery_context: Vec<crate::agent::club::RecoveryContextRef>,
}
    ...
    pub(crate) fn from_turn(
        ...
        let infrastructure =
            (kind == TerminationKind::ProviderFailure).then(|| InfrastructureFailure {
                ...
                retryable: false,
                detail_sha256: crate::knowledge::cut::sha256_hex(stop_reason.as_bytes()),
            });
        Self {
            kind,
            ...
            final_answer_sha256: final_answer
                .map(|answer| crate::knowledge::cut::sha256_hex(answer.as_bytes())),
        }
    }
    ...
    pub(crate) fn process_lost() -> Self {
        Self {
            ...
            infrastructure: Some(InfrastructureFailure {
                ...
                retryable: false,
                detail_sha256: crate::knowledge::cut::sha256_hex(b"process_lost"),
            }),
