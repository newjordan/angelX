...
use crate::agent::tools::nav::{DefsTool, GrepTool, OutlineTool};
...
pub(super) fn navigation(root: &Path, args: &Value, kind: NavKind) -> Result<String, String> {
    ...
    let text = crate::agent::harness::confined_read(root, Path::new(path))?;
...
#[cfg(test)]
#[path = "../../../../tests/cockpit/app/lsp__parity__tests.rs"]
mod tests;
