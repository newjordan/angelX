...
use crate::agent::harness::{Tool, output_timed_fixed_captured};
...
impl Tool for ToolRepairTool {
    ...
    fn call(&self, args: &Value) -> Result<String, String> {
        ...
        let limit = if crate::platform::yolo::enabled() {
            0
        } else {
            crate::agent::harness::env_usize("ANGEL_TOOL_REPAIR_LIMIT", 2)
        };
