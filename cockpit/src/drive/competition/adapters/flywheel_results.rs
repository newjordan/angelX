...
use crate::drive::competition::profile::{DeepCutProfileIdentityV1, DeepCutProfileV1};
use crate::drive::competition::rewards::{
    OfficialProvenanceV1, OfficialResultSourceV1, OfficialResultV1, RewardContextV1, RewardLedgerV1,
};
use crate::drive::competition::schema::AdapterIdentityV1;
...
fn parse_fires(state_dir: &Path) -> Result<Vec<ParsedFireV1>, AdapterFailureV1> {
    ...
    for (index, line) in body.lines().enumerate() {
        ...
        fires.push(ParsedFireV1 {
            fire,
            receipt_sha256: crate::knowledge::cut::sha256_hex(line.as_bytes()),
        });
    }
    Ok(fires)
}
