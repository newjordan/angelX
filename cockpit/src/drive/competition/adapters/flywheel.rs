    ...
    fn open_with_me(state_dir: &Path, me_override: Option<&str>) -> Result<Self, AdapterFailureV1> {
        ...
        Ok(Self {
            identity: AdapterIdentityV1 {
                ...
                runtime_sha256: crate::knowledge::cut::sha256_hex(&identity_bytes),
                capabilities: [
            ...
            me,
            observed_at_ms,
            raw_rows_sha256: crate::knowledge::cut::sha256_hex(&files.rows_bytes),
        })
    }
...
impl CompetitionAdapterV1 for FlywheelAdapterV1 {
    ...
    fn fetch_personal_submissions(
        ...
        let raw = crate::knowledge::cut::sha256_hex(
            entries
                .iter()
