...
use crate::drive::competition::schema::{RetryPolicyV1, ScoreV1};
...
pub(crate) fn malformed(detail: &str) -> AdapterFailureV1 {
    AdapterFailureV1 {
        ...
        detail_sha256: crate::knowledge::cut::sha256_hex(detail.as_bytes()),
        provenance_sha256: crate::knowledge::cut::sha256_hex(FLYWHEEL_PROVENANCE.as_bytes()),
    }
}
