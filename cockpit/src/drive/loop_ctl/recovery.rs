...
pub struct ExperimentRecord {
    ...
    pub(crate) context_ref: Option<crate::agent::club::RecoveryContextRef>,
    #[serde(default)]
...
fn recovery_workspace_sha256(workspace: &Path) -> String {
    crate::knowledge::cut::sha256_hex(workspace.as_os_str().as_encoded_bytes())
}
...
fn recovery_reference(
    ...
    key: &str,
    summary: &str,
    producer: Option<crate::agent::club::RecoveryProducerRef>,
) -> crate::agent::club::RecoveryContextRef {
    let workspace_sha256 = recovery_workspace_sha256(workspace);
    crate::agent::club::RecoveryContextRef {
        import_id: crate::knowledge::cut::sha256_hex(
            &serde_json::to_vec(&(run_id, &workspace_sha256, key))
                .expect("import identity serializes"),
        ),
        loop_run_id: run_id.into(),
        workspace_sha256,
        experiment_key_sha256: crate::knowledge::cut::sha256_hex(key.as_bytes()),
        summary_sha256: crate::knowledge::cut::sha256_hex(summary.as_bytes()),
        producer,
    }
}
...
impl crate::App {
    ...
    pub(crate) fn loop_drain_experiment(&mut self) {
        ...
        let (status, summary, producer, supervisor_only) = match result {
            Ok(result) => {
                ...
                let producer = result.result_sha256.map(|result_sha256| {
                    crate::agent::club::RecoveryProducerRef {
                        task_sha256: result.task_sha256,
                        source_snapshot_sha256: result.snapshot_sha256,
                        answer_sha256: crate::knowledge::cut::sha256_hex(result.answer.as_bytes()),
                        result_sha256,
    ...
    pub(crate) fn loop_recovery_context_refs(&self) -> Vec<crate::agent::club::RecoveryContextRef> {
        ...
        if !self.loop_ctl.pending_proc_completions.is_empty() {
            for reference in &self.loop_ctl.pending_recovery_contexts {
                ...
                if !self
                    ...
                    .iter()
                    .any(|summary| {
                        crate::knowledge::cut::sha256_hex(summary.as_bytes())
                ...
                .filter(|reference| {
                    reference.summary_sha256
                        ...
                        && reference.experiment_key_sha256
                            == crate::knowledge::cut::sha256_hex(record.key.as_bytes())
        ...
        crate::agent::club::recovery_context_refs(&[message])
    }
...
#[cfg(test)]
#[path = "../../../../tests/cockpit/loop_ctl/recovery__tests.rs"]
mod tests;
