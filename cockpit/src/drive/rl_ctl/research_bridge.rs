...
fn runtime() -> Result<PathBuf, String> {
    ...
    let root = rl_root()
        ...
        .join(crate::knowledge::cut::sha256_hex(identity.as_bytes()));
    ensure_dir(&root)?;
...
pub(super) fn transform(
    ...
    command
        ...
        .current_dir(&spool.0);
    let result =
        crate::agent::harness::output_timed_captured_cancellable(command, None, Some(cancel))
...
#[cfg(test)]
#[path = "../../../../tests/cockpit/app/rl_ctl__research_bridge__tests.rs"]
mod tests;
