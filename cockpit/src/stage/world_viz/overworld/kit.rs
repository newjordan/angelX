...
pub(crate) fn heart(fill: u8) -> Img {
    let mut im = Img::from_rows(&[
        ".77.77.", "7977777", "7777777", ".77777.", "..777..", "...7...",
    ]);
    match fill {
        1 => {
            for y in 0..6 {
        ...
        0 => {
            ...
            for y in 0..6 {
                for x in 0..7 {
                    if src.solid(x, y) {
                        im.put(x, y, if src.edge(x, y) { '8' } else { 'K' });
                    }
                }
            }
        }
...
pub(crate) fn gem() -> Img {
    Img::from_rows(&["..k..", ".k5k.", "k565k", "k454k", ".k4k.", "..k.."])
}

pub(crate) fn key() -> Img {
    Img::from_rows(&[
        ".kkk.", "k9.9k", ".k9k.", "..9..", "..99.", "..9..", "..99.",
    ])
}
