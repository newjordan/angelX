...
pub(crate) fn try_image(
    ...
    height: usize,
    motion: MotionMode,
) -> Option<Arc<crate::ui::term::art::ColoredBrailleImage>> {
    ...
    Some(Arc::new(crate::ui::term::art::ColoredBrailleImage {
        width,
        height,
        cells,
    }))
...
fn art_frame(
    ...
    art_height: usize,
    motion: MotionMode,
) -> Option<(Arc<crate::ui::term::art::ColoredBrailleImage>, usize, usize)> {
    ...
    let cache_stem = crate::ui::term::art::image_path_key(&spec.path);
    let image = crate::ui::term::art::colored_rgba_region_braille(
        &sheet, cache_stem, rect, cell_w, cell_h, true,
    )?;
...
fn pane_from_image(
    image: &crate::ui::term::art::ColoredBrailleImage,
    pane_w: usize,
    pane_h: usize,
    origin_x: usize,
    origin_y: usize,
...
fn default_root() -> PathBuf {
    crate::platform::runtime_paths::cockpit_dir().join("assets/knight-journey")
}
