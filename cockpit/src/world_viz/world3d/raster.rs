...
const NIGHT_HAZE: [u8; 3] = crate::identity::NOIR_NIGHT_HAZE;
const SKY_ZENITH: [u8; 3] = crate::identity::NOIR_SKY_ZENITH;
const SKY_HORIZON: [u8; 3] = crate::identity::NOIR_SKY_HORIZON;
const MOON_SILVER: [u8; 3] = crate::identity::NOIR_MOON_SILVER;
