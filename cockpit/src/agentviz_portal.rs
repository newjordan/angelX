...
fn discover_renderer() -> Option<PathBuf> {
    ...
    let renderer_target = Path::new(env!("CARGO_MANIFEST_DIR"))
...
mod tests {
    use super::*;
    use crate::agentviz::StageSnapshot;

    fn fixture(name: &str) -> AngelVizStateV1 {
        let raw = match name {
            "normal" => include_str!("../fixtures/agentviz-portal/normal-v1.json"),
            "empty" => include_str!("../fixtures/agentviz-portal/empty-v1.json"),
            "oversized" => include_str!("../fixtures/agentviz-portal/oversized-v1.json"),
            "stale" => include_str!("../fixtures/agentviz-portal/stale-v1.json"),
            "invalid" => include_str!("../fixtures/agentviz-portal/invalid-v1.json"),
