...
impl EvaluatorSpec {
    ...
    pub fn command_success(
        ...
        let fixture_sha256 = crate::harness::workspace_evidence_sha256(&fixture_root)
    ...
    fn build(
        ...
        let command_sha256 = crate::cut::sha256_hex(command.as_bytes());
        let inventory_command_sha256 = crate::cut::sha256_hex(inventory_command.as_bytes());
        ...
        let verifier_bundle_sha256 = crate::cut::sha256_hex(canonical_verifier.as_bytes());
        ...
        Ok(Self {
            ...
            kind,
            resolved_tools,
            manifest_sha256: crate::cut::sha256_hex(canonical.as_bytes()),
        })
    }
    ...
    pub fn validate_runtime(&self) -> Result<(), String> {
        let fixture_sha256 = crate::harness::workspace_evidence_sha256(&self.fixture_root)
            .ok_or_else(|| "evaluator fixture is no longer a Git-backed workspace".to_string())?;
...
impl PolicyEvaluationRequest<'_> {
    ...
    pub fn canonical_pair_id(&self) -> String {
        ...
        for value in [
            ...
            crate::cut::sha256_hex(self.task.as_bytes()),
    ...
    fn canonical_subject_for(&self, receipt_role: &str) -> String {
        ...
        for value in [
            ...
            self.policy_version.to_string(),
            self.sample_index.to_string(),
            crate::cut::sha256_hex(self.candidate.output.as_bytes()),
        ] {
