...
pub(crate) fn authority_root() -> PathBuf {
    match std::env::var("ANGEL_REINFORCE_AUTHORITY_DIR") {
        ...
        _ => crate::workspace_store::angel_subdir("reinforce-authority"),
    }
}
...
impl TechnicalCampaignAuthority {
    pub fn new(campaign_id: impl Into<String>) -> Result<Self, String> {
        ...
        let directory = crate::cut::sha256_hex(campaign_id.as_bytes());
    ...
    pub(super) fn install_or_adopt_candidate(
        ...
        let mut record = FrozenTrainingProposal {
            ...
            incumbent_prompt_sha256: crate::cut::sha256_hex(incumbent_prompt.as_bytes()),
            incumbent_version,
            candidate_prompt: candidate_prompt.to_string(),
            candidate_prompt_sha256: crate::cut::sha256_hex(candidate_prompt.as_bytes()),
            metrics,
    ...
    fn decode_candidate(
        ...
        if record.schema != CANDIDATE_SCHEMA
            ...
            || record.incumbent_prompt_sha256
                != crate::cut::sha256_hex(record.incumbent_prompt.as_bytes())
            || record.candidate_prompt_sha256
                != crate::cut::sha256_hex(record.candidate_prompt.as_bytes())
    ...
    pub fn release_anchor_sha256(&self) -> Result<String, String> {
        ...
        Ok(crate::cut::sha256_hex(&snapshot.bytes))
    }
