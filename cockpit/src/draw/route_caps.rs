...
pub(crate) fn model_capability_detail(metadata: &crate::club::RouteMetadata) -> String {
...
pub(crate) fn route_capability_facts(metadata: &crate::club::RouteMetadata) -> Vec<String> {
    let mut facts = vec![
        metadata
            .output_budget
