...
use crate::agent::sandbox::process_owner::{ChildClaim, claim_spawn};
...
impl ShellPane {
    ...
    pub fn mouse_mode(
        ...
        crate::ui::mouse::TrackMode,
        crate::ui::mouse::ReportEncoding,
    ) {
        use vt100::{MouseProtocolEncoding as E, MouseProtocolMode as M};
        let Ok(parser) = self.parser.lock() else {
            return (
                crate::ui::mouse::TrackMode::None,
                crate::ui::mouse::ReportEncoding::Sgr,
            );
        };
        let screen = parser.screen();
        let mode = match screen.mouse_protocol_mode() {
            M::None => crate::ui::mouse::TrackMode::None,
            M::Press => crate::ui::mouse::TrackMode::Press,
            M::PressRelease => crate::ui::mouse::TrackMode::PressRelease,
            M::ButtonMotion => crate::ui::mouse::TrackMode::ButtonMotion,
            M::AnyMotion => crate::ui::mouse::TrackMode::AnyMotion,
        };
        let enc = match screen.mouse_protocol_encoding() {
            E::Sgr => crate::ui::mouse::ReportEncoding::Sgr,
            _ => crate::ui::mouse::ReportEncoding::X10,
        };
        (mode, enc)
    }
