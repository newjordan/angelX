...
use crate::club::{ChatMsg, MAX_IMAGE_ATTACHMENT_BYTES, Media};
...
impl ClipboardPaste {
    ...
    pub(crate) fn chip(&self, can_remove: bool) -> Option<String> {
        let bytes = crate::media::format_bytes(self.staged_bytes());
...
fn fetch_kinds(
    ...
    match read_kind(
        ...
        program,
        text,
        crate::app_control::MAX_COMPOSER_PASTE_BYTES,
    ) {
        ...
        KindRead::Over => Err(format!(
            ...
            crate::app_control::MAX_COMPOSER_PASTE_BYTES / 1024
        )),
