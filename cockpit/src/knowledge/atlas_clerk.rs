...
use crate::agent::backplane::{BackplaneRegistry, LeaseMode, ModelRevision, RouteId, WorkloadRole};
...
impl AtlasClerkWorker {
    pub(crate) fn shared(atlas: Arc<crate::knowledge::atlas::AtlasService>) -> Arc<Self> {
    ...
    pub(crate) fn tick(
        ...
        let spawn_result = std::thread::Builder::new()
            ...
            .spawn(move || {
                let result = crate::ui::term::catch_background_unwind(|| {
...
fn run_one(
    ...
    route: &ClerkRoute,
    lease: &crate::agent::backplane::ResourceLease,
    harvest: &crate::knowledge::atlas::HarvestPack,
