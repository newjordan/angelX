...
pub(crate) fn render_header(
    ...
    let save_degraded = matches!(
        ...
        crate::knowledge::session::SessionSaveStatus::Failed(_)
    );
    if save_degraded {
...
pub(crate) fn input_line_with_slash_ghost<'a>(
    ...
    let Some(hint) = crate::ui::input::slash_inline_hint(input, cursor) else {
...
fn register_transcript_copy_pane(app: &mut App, transcript_frame: Rect) {
    ...
    if let Some(prose) = crate::ui::surfaces::transcript_live_copy_rect(transcript_frame, strip_h) {
...
pub(crate) fn render_cockpit_with_agent_panels(
    ...
    let backdrop = crate::ui::surfaces::BackdropMode::from_env();
    let join = crate::ui::surfaces::SurfaceJoin::from_env();
    ...
    if !app.scryglass_enabled || !backdrop.shows_side_column() {
        let plan =
            crate::ui::surfaces::plan_cockpit_surfaces(crate::ui::surfaces::CockpitLayoutInput {
                area: cockpit_area,
                agent_active: false,
    ...
    let raytrace_active =
        app.scryglass.controller.route() == crate::ui::scryglass::StageRoute::Raytrace;
    ...
    let reinforce_active = app.scryglass.controller.route()
        == crate::ui::scryglass::StageRoute::Reinforce
    ...
    let artifacts_active = stage_view::artifacts_pane_active(
        ...
        crate::ui::viz::loop_viz::visible(&app.loop_ctl),
        reinforce_active,
    );
    ...
    let layout_input = crate::ui::surfaces::CockpitLayoutInput {
        area: cockpit_area,
        agent_active,
        artifacts_active,
        reasoning_visible,
    ...
    let target_plan = crate::ui::surfaces::plan_cockpit_surfaces(layout_input);
    ...
    let plan = crate::ui::surfaces::plan_cockpit_surfaces_at_height(layout_input, Some(height));
...
pub(crate) fn render_selection_and_approval_overlays(frame: &mut Frame, app: &mut App) {
    if app.pending_approval.is_none() {
        ...
        app.selection = app.selection.take().and_then(|mut sel| {
            if !crate::ui::surfaces::pane_accepts_clipboard(sel.pane) {
                return None;
            }
        ...
        if let Some(dialog) = app.loop_dialog.as_ref() {
            app.loop_dialog_hits = crate::drive::loop_dialog::render(frame, frame.area(), dialog);
        }
    }

    if let Some(pa) = &app.pending_approval {
        let area = crate::ui::views::approval_view::modal_area(
            frame.area(),
            &pa.prompt,
        ...
        frame.render_widget(
            Paragraph::new(crate::ui::views::approval_view::body(
                &pa.prompt,
                pa.scope_label.as_deref(),
            ))
            .wrap(Wrap { trim: false })
            .block(crate::ui::views::approval_view::block()),
            area,
        );
    }
}
...
pub(crate) fn ui(frame: &mut Frame, app: &mut App) {
    ...
    let sections = Layout::vertical([
        ...
        Constraint::Min(1),
        Constraint::Length(crate::ui::views::status_view::composer_height(
            &app.input,
            framed.width,
    ...
    if app.shell_focused && app.shell.is_some() {
        ...
        let block = Block::default()
            ...
            .title(crate::ui::views::status_view::shell_focus_title());
        ...
        && crate::ui::surfaces::BackdropMode::from_env().paints_in_process()
    {
        ...
        let paint_backdrops = app.scryglass_enabled
            && crate::ui::surfaces::BackdropMode::from_env().paints_in_process();
    ...
    if app.shell_focused {
        let hint = Paragraph::new(crate::ui::views::status_view::shell_hint())
    ...
    if app.moa_deck_owns_input() {
        app.world_pane_visible = false;
        app.scryglass.begin_frame();
        app.scryglass.surface = crate::ui::scryglass::StageSurface::Moa;
        app.agent_buttons
...
pub(crate) fn render_message_composer(frame: &mut Frame, app: &mut App, area: Rect) {
    let intent = crate::ui::views::status_view::composer_intent(&app.input);
    let busy = app.thinking.is_some() || app.bg_job.is_some();
    let steerable = matches!(
        intent,
        crate::ui::views::status_view::ComposerIntent::Empty
            | crate::ui::views::status_view::ComposerIntent::Message
    );
    ...
    let mut title = crate::ui::views::status_view::composer_frame_title(
        intent,
        area.width.saturating_sub(2) as usize,
        crate::ui::views::status_view::ComposerTitleState {
            busy,
            steerable,
    ...
    let mut composer: crate::ui::views::status_view::ComposerView<'_> =
        crate::ui::views::status_view::composer_view_with_selection(
            input,
            inner_w,
            inner_h,
            cursor,
        ...
        && !input.chars().any(char::is_whitespace)
    {
    ...
    } else if intent == crate::ui::views::status_view::ComposerIntent::Empty {
        if composer.lines.is_empty() {
            composer.lines.push(if app.tutor_draft.is_some() {
                ...
                crate::ui::views::status_view::composer_placeholder(busy, inner_w)
            });
    ...
    crate::ui::views::status_view::pad_composer_lines(&mut composer.lines, inner_w);
    ...
    while composer.lines.len() < inner_h as usize {
        composer.lines.push(Line::from(Span::styled(
            crate::ui::views::status_view::pad_composer_row("", inner_w),
    ...
    let (mut border_style, mut title_style) = match intent {
        ...
        crate::ui::views::status_view::ComposerIntent::Command => (
            Style::new().fg(hud::HUD_GOLD),
            Style::new().fg(hud::HUD_GOLD).add_modifier(Modifier::BOLD),
        ),
        crate::ui::views::status_view::ComposerIntent::CriticalCommand => (
    ...
    if busy && intent != crate::ui::views::status_view::ComposerIntent::CriticalCommand {
        border_style = Style::new().fg(HUD_PHOSPHOR);
        title_style = PHOSPHOR_BOLD_STYLE;
    }
    if intent == crate::ui::views::status_view::ComposerIntent::CriticalCommand
...
pub(crate) fn composer_cursor_position(
    app: &App,
    area: Rect,
    composer: &crate::ui::views::status_view::ComposerView<'_>,
...
pub(crate) fn render_rl_preview_text(
    view: crate::ui::viz::rl_viz::RlView,
    width: u16,
    height: u16,
    ...
    app.rl_view = view;
    app.tools.rl().mode = crate::drive::rl_ctl::RlMode::Campaign;
    {
        let rl = app.tools.rl();
        ...
        progress.outcome = Some(Ok(crate::drive::rl_ctl::CampaignOutcome {
            attempted: 81,
            passed: 74,
            red: 7,
            rounds: 1,
...
pub(crate) fn render_research_preview_text(
    lens: crate::drive::research_workspace::Lens,
    width: u16,
    height: u16,
) -> std::io::Result<String> {
    ...
    app.research
        .action(crate::drive::research_workspace::Action::Lens(lens));
...
pub(crate) fn render_scryglass_preview_text(
    ...
    let _ = app
        .module_host
        .focus(&crate::platform::runtime::ModuleId::new("artifacts"));
    let card = crate::ui::media::visual_from_path(path)
...
fn render_scene_caption(
    ...
    use crate::ui::hud::{HUD_DIM, HUD_TEXT};
...
fn clip_caption(line: Line<'static>, max: usize) -> Line<'static> {
    ...
    if max > 0 {
        spans.push(Span::styled(
            crate::ui::glyphs::chrome_ellipsis(),
...
fn formation_status_bar(app: &mut App, bar: Rect) -> Line<'static> {
    use crate::ui::hud::{HUD_BLUE, HUD_DIM, HUD_PHOSPHOR};
...
fn render_moa_deck(frame: &mut Frame, app: &mut App, area: Rect) {
    ...
    let selected_idx = app
        ...
        .unwrap_or(0);
    let deck = crate::agent::formations::built_in_deck();
...
fn render_moa_deck_detail(
    ...
    app: &mut App,
    area: Rect,
    formation: crate::agent::formations::Formation,
) {
    if area.width == 0 || area.height == 0 {
        return;
    }
    ...
    if focus == crate::agent::formations::MoaDeckFocus::Models {
    ...
    } else if focus == crate::agent::formations::MoaDeckFocus::Efforts {
...
fn render_moa_roster_graph(
    ...
    selected_slot: usize,
    focus: crate::agent::formations::MoaDeckFocus,
) {
    ...
    for (role_index, role) in active_roles.iter().enumerate() {
        ...
        for (chunk_index, chunk) in role_slots.chunks(per_row).enumerate() {
            ...
            for (position, (slot_index, slot)) in chunk.iter().enumerate() {
                ...
                let style = if selected && focus == crate::agent::formations::MoaDeckFocus::Slots {
                    Style::new()
...
fn render_moa_model_picker(
    ...
    formation: crate::agent::formations::Formation,
    selected_slot: usize,
    models: &[crate::agent::formations::MoaModelChoice],
...
#[cfg(test)]
#[path = "../../../tests/cockpit/app/draw__moa_think_tests.rs"]
mod moa_think_tests;

#[cfg(test)]
#[path = "../../../tests/cockpit/app/draw__caption_tests.rs"]
mod caption_tests;
