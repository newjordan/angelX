    ...
    std::thread::scope(|scope| {
        let handles = calls
            ...
            .map(|(local_index, call)| {
                ...
                let live_model = crate::harness::run_identity::live_model();
                let live_turn = crate::harness::run_identity::live_turn();
                let handle = scope.spawn(move || {
                    let _model = crate::harness::run_identity::LiveModelScope::enter(live_model);
                    let _turn = crate::harness::run_identity::LiveTurnScope::enter(live_turn);
                    ...
                    let result = crate::tools::http_transport::with_context(http_context, || {
                    ...
                    sandbox_receipts.lock().unwrap()[index_offset + local_index] =
                        crate::harness::exec::sandbox_receipt();
