use super::schema::*;
use super::store::*;
use crate::club::{ChatMsg, ChatRole, ClubReply, Media, RouteIdentity, ToolDef};
...
impl RolloutRecorder {
    ...
    pub(crate) fn observe_task_verifier(
            ...
            && outcome.verification == VerificationOutcome::Passed
        {
            active.coding_eval_evidence = Some(CodingEvalEvidence {
                ...
                call_id_sha256: crate::cut::sha256_hex(call.id.as_bytes()),
                arguments_sha256: crate::cut::sha256_hex(call.args.to_string().as_bytes()),
                receipt_sha256: crate::cut::sha256_hex(result.as_bytes()),
    ...
    pub(crate) fn observe_cut_machine(&mut self, machine: &serde_json::Value) {
        ...
        let observation = CutEvidenceObservation {
            ...
            command_sha256: crate::cut::sha256_hex(command.as_bytes()),
            directory_sha256: crate::cut::sha256_hex(directory.as_bytes()),
            source_sha256: crate::cut::sha256_hex(source.as_bytes()),
            exit,
            passed: exit == 0,
            duration_ms: object
                .get("dur_ms")
            ...
            diagnostic_sha256: object
                .get("err")
                .and_then(serde_json::Value::as_str)
                .map(|error| crate::cut::sha256_hex(error.as_bytes())),
        };
    ...
    pub(crate) fn fail_policy_attempt(
        ...
        let failure = InfrastructureFailure {
            ...
            detail_sha256: crate::cut::sha256_hex(error.as_bytes()),
        };
    ...
    pub(crate) fn finish_turn(
        ...
        if let Err(error) = active.store.append_event(
            ...
            active.manifest.eligibility = TrainingEligibility::Excluded {
                ...
                detail_sha256: Some(crate::cut::sha256_hex(error.as_bytes())),
            };
...
fn media_ref(media: &Media) -> MediaRef {
    match media {
        Media::Image { mime, b64 } => MediaRef {
            ...
            sha256: crate::cut::sha256_hex(b64.as_bytes()),
            body_stored: false,
        },
